...
class Ui_Rules(object):
    ...
    def setupUi(self, Form):
        ...
        self.text_ll.setText(
            ...
            'пополнив таблицу результатов своим выигрышем с указанным именем и датой игры.</p><p>Во время игры у вас '
            'есть возможность выбрать любые четыре из предложенных опций.<br>Будьте осторожны, ведь как только вы '
            'выберете четвёртую опцию, выбор всех оставшихся будет закрыт. <b>Расходуйте подсказки разумно!</b></p><p>'
            '<b>«50:50»</b> убирает два неверных ответа – полезна, если не уверены в своём выборе. <br>'
            '<b>«Помощь зала»</b> попросит помощи у виртуального зала, который может помочь вам с ответом<br>на вопрос'
            '.<br><b>«Право на ошибку»</b> даёт вам возможность ошибиться при ответе один раз — отличная страховка на '
            'сложных вопросах.<br><b>«Замена вопроса»</b> заменяет текущий вопрос на другой — пригодится, если не '
            'разбираетесь<br>в теме вопроса.<br><b>«Возрождение»</b> восстанавливает и вновь использует одну из ранее '
            'использованных подсказок — при активации необходимо сразу выбрать подсказку.<br><b>«Иммунитет»</b> '
            'защищает вас от неправильного ответа — если вы ошибётесь, то покинете игру<br>с уже заработанной суммой.'
            '<br><b>«Заморозка таймера»</b> замораживает таймер на текущем вопросе, пока вы не ответите<br>или не '
            'воспользуйтесь «Заменой вопроса» — опция активна только в режиме на время.<br><b>«Забрать деньги»</b> — '
            'или вы можете покинуть игру с уже заработанным выигрышем,<br>чтобы не потерять всё до несгораемой суммы.'
            '</p></body></html>'
        )
